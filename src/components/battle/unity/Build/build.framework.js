...
var ASM_CONSTS = {
  4986452: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 4986507: function($0) {performance.now = function() { return $0; };},  
 4986555: function($0) {performance.now = function() { return $0; };},  
 4986603: function() {performance.now = Module['emscripten_get_now_backup'];},  
 4986658: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 4986719: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 4986783: function() {return Module.webglContextAttributes.powerPreference;}
};
...
var asmLibraryArg = {
  ...
  "invoke_viiiiffiddi": invoke_viiiiffiddi,
...
/** @type {function(...*):?} */
var dynCall_viiiiffiddi = Module["dynCall_viiiiffiddi"] = createExportWrapper("dynCall_viiiiffiddi");
...
/** @type {function(...*):?} */
var dynCall_viiifddii = Module["dynCall_viiifddii"] = createExportWrapper("dynCall_viiifddii");
...
function invoke_viiiiffiddi(index,a1,a2,a3,a4,a5,a6,a7,a8,a9,a10) {
  var sp = stackSave();
  try {
    dynCall_viiiiffiddi(index,a1,a2,a3,a4,a5,a6,a7,a8,a9,a10);
  } catch(e) {
    stackRestore(sp);
    if (e !== e+0) throw e;
    _setThrew(1, 0);
